    ...
    <div id="app">
        ...
        <main>
            ...
            <transition name="slide" v-on:before-leave="scrollToTop">
                ...
                <welcome
                    v-if="state === constants.applicationState.WELCOME"
                    v-bind:session="session"
                />
                <presentation
                    v-if="state === constants.applicationState.FEATURE"
                    v-bind:features="features"
                    v-bind:slideFeatureId="slideFeatureId"
                />
                <session-summary
                    v-if="state === constants.applicationState.SUMMARY"
                    v-bind:session="session"
                    v-bind:features="features"
                />
                <session-report
                    v-if="state === constants.applicationState.CLOSED"
                    v-bind:session="session"
                />
            </transition>
        </main>
...
export default {
    ...
    created: function() {
        ...
        const connect = () => {
            ...
            socket.on('switch-slide', message => {
